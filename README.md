...
[![Github CI](https://github.com/DenLakusta/SecurePassPush/actions/workflows/ruby.yml/badge.svg)](https://github.com/DenLakusta/SecurePassPush/actions/workflows/ruby.yml)
...
* [Slack: How to Add a Custom Slash Command](https://github.com/DenLakusta/SecurePassPush/wiki/PasswordPusher-&-Slack:-Custom-Slash-Command)

* [Alfred Workflow](http://www.packal.org/workflow/passwordpusher) for Mac users

## API

* [JSON API](https://github.com/DenLakusta/SecurePassPush/wiki/Password-API)
...
[Learn more](https://github.com/DenLakusta/SecurePassPush/tree/master/containers/docker#pwpush-ephemeral)

**➜ using an External Postgres Database**

    docker run -d -p "5100:5100" pglombardo/pwpush-postgres:1.10.0

[Learn more](https://github.com/DenLakusta/SecurePassPush/tree/master/containers/docker#pwpush-postgres-external-database)
...
[Learn more](https://github.com/DenLakusta/SecurePassPush/tree/master/containers/docker#pwpush-postgres)

## On Kubernetes

Instructions and explanation of a Kubernetes setup [can be found
here](https://github.com/DenLakusta/SecurePassPush/tree/master/containers/kubernetes).
...
See our [OpenShift documentation](https://github.com/DenLakusta/SecurePassPush/tree/master/containers/docker#pwpush-openshift).

## On Heroku

One click deploy to [Heroku Cloud](https://www.heroku.com) without having to set up servers.

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/DenLakusta/SecurePassPush)
...
* [@fiskhest](https://github.com/fiskhest) the [Kubernetes installation instructions and manifests](https://github.com/DenLakusta/SecurePassPush/tree/master/containers/kubernetes).

* [@sfarosu](https://github.com/sfarosu) for [contributing](https://github.com/DenLakusta/SecurePassPush/pull/82) the Docker, Kubernetes & OpenShift container support.
...
* [Kasper 'kapöw' Grubbe](https://github.com/kaspergrubbe) for the [JSON POST fix](https://github.com/DenLakusta/SecurePassPush/pull/3).

* [JarvisAndPi](http://www.reddit.com/user/JarvisAndPi) for the favicon design

...and many more.  See the [Contributors page](https://github.com/DenLakusta/SecurePassPush/graphs/contributors) for more details.
