...
To run a version with postgres, use [this docker-compose.yml file](https://github.com/DenLakusta/SecurePassPush/blob/master/docker/pwpush-postgres/docker-compose.yaml).
...
You can run Password Pusher in OpenShift in 2 ways:
  ...
  - from an OpenShift template/buildconfig/deploymentconfig and PostgreSQL persistent from the official OpenShift template:
    ...
    cd ~ && git clone https://github.com/DenLakusta/SecurePassPush.git && cd ~/PasswordPusher/docker/passwordpusher-openshift
